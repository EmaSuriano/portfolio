...
In this article, we will be exploring the process of building a website in [Astro](https://astro.build/) using three different frameworks: React, Svelte, and Vue.js. In a previous article, we discussed the architecture behind Astro the fundamentals of website building and the importance of choosing the right framework for your project. If you are new to website building, we recommend checking out that article here: [Understanding Astro islands architecture](https://blog.logrocket.com/understanding-astro-islands-architecture/).

Each of these frameworks has its own strengths and weaknesses, and in this article, we will be providing a step-by-step guide on how to build a website using each of them. By the end of this article, you will have a clear understanding of the different approaches and tools needed for building a website in Astro using these popular frameworks.

I would say that we cover most of the theory parts that we need to know to build something meaningful. Thanks to the idea that each Island can be considered as a _stand-alone_ container, we can easily combine different frameworks into one project. I came up with the idea of building a fully functional Dashboard using 3 different frameworks: React, Vue and Svelte.

This means that I can take the best of each framework and put it into the project. In the demo, I installed the following libraries per frameworks:
