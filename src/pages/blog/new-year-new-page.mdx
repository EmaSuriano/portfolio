...
I kept in a separate branch the previous website, to have it as a _memento_ and also to come back at any point if there was something that I didn't migrate yet. You can check out the legacy website [here](https://63b5a8db12a7da186b68d5d9--emasuriano.netlify.app/).

![portfolio](images/2023-01-18-10-45-32.png)
