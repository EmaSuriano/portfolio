---
title: Using Storybook as a powerful Visual Testing Platform
author: Ema Suriano
date: 2019-10-01
...
_Photo by [Markus Spiske](https://unsplash.com/@markusspiske?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/hqCEQTc5gZA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)_
...
![Storybook Demo](./images/storybook-demo.gif)
...
![Example of Visual Testing Diff](./images/visual-diff.png)
...
![It's Show Time](./images/show-time.gif)
...
![Storybook Homepage](./images/storybook-homepage.png)
...
![Demo DuplicationButton stories](./images/duplication-button.gif)
...
![Test result with storyshots](./images/result-storyshots.png)

## Let’s get Visual! 🌈

![Visual Illusion](./images/visual-illusion.gif)
...
![Running visual testing along with Storybook](./images/visual-testing-storyshots.png)
...
In the following diffing I changed the border-color of the button from pink to blue. The original image will be on the left, the new on the right and in the middle the difference between both with the changes in red color.

![Visual diffing in action](./images/visual-testing-storyshots.png)
...
![Test CI output](https://cdn-images-1.medium.com/max/2264/1*KekXGREL7z3wIjT3q_Q9cw.png)
_Test CI output_
...
![Interactive visual testing](./images/interactive-testing.png)
...
![weather-styled-icon showcase](./images/weather-styled-icon.gif)
...
![Visual testing lines diff weather-styled-icon](./images/pr-diff.png)
