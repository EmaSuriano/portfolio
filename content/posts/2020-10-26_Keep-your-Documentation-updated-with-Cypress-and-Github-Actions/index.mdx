...
excerpt: I've been trying to document all my projects by adding screenshots of the pages, in order to provide a quick overview of everything the project provides to the people who find it for the first time. But every time I had to make to change on the UI, these screenshots were out-dated ... In this post, I want to share the workaround I came up, to make this process autonomous by using Cypress and Github Actions.
secret: false
---
